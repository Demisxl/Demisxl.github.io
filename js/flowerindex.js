...
const helpContent = {
	shellType: {
		header: '烟花类型',
		body: '选择发射的烟花类型。选择“随机”以获得一个不错的观景体验'
	},
	shellSize: {
		header: '烟花尺寸',
		body: '选择烟花的大小。模拟真实的烟花炮弹大小，更大的炮弹具有更大的爆发和更好的观赏体验，有时会产生更复杂的效果。然而，较大的烟花也需要更多的处理能力，并可能导致延迟。'
	},
	quality: {
		header: '烟花尺寸',
		body: '整体图形质量。如果动画运行不顺畅，请尝试降低质量。高质量会大大增加渲染的火花量，并可能导致延迟。'
	},
	skyLighting: {
		header: '夜空亮度',
	...
	scaleFactor: {
		header: '相对远近',
		body: '允许缩放所有烟花的大小，本质上是将您移近或移远,50-100可以取得最好的观赏体验。对于更大的外壳尺寸，可以方便地缩小一点，特别是在手机或平板电脑上。'
	},
	autoLaunch: {
		header: '自动发射',
		body: '自动发射烟火序列。坐下来欣赏表演，或禁用以完全控制。'
	},
	finaleMode: {
		header: '提前过年',
		body: '发射密集的烟火。这可能会导致延迟。需要启用“自动点火”。'
	},
	hideControls: {
		header: '相机模式',
		body: '隐藏屏幕顶部的半透明控件。对于屏幕截图很有用，或者只是一种更无缝的体验。隐藏时，您仍然可以点击右上角重新打开此菜单。'
	},
	fullscreen: {
		header: '进入全屏',
		body: '切换全屏模式。'
	...
	longExposure: {
		header: '烟花轨迹',
		body: '保留烟花的运行轨迹，保留长条纹光的实验效果，类似于打开相机快门。'
	}
};
